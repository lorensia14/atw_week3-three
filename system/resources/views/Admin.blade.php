          ...
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="/index.html">
                ...
                <span class="brand-name">LS - Book Store</span>
              </a>
            </div>
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li  class="has-sub active expand" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#dashboard"
                      ...
                      <span class="nav-text">Beranda</span> <b class="caret"></b>
                    </a>
            ...
            <div class="sidebar-footer">
              <div class="sidebar-footer-content">
                <h6 class="text-uppercase">
                  Cpu Uses <span class="float-right">50%</span>
                </h6>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      ...
                      <span class="d-none d-lg-inline-block">Lorensia</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        ...
                        <div class="d-inline-block">
                          Lorensia <small class="pt-1">lorensiav95@gmail.com</small>
                        </div>
                      </li>
                      ...
                      <li class="dropdown-footer">
                        <a href="sign-in.html"> <i class="mdi mdi-logout"></i> Log Out </a>
                      </li>
                    </ul>
                  </li>
                </ul>
        ...
        <div class="content-wrapper">
          <div class="content">						 
                          ...
                          <div class="card-body slim-scroll">
                            <div class="media pb-3 align-items-center justify-content-between">
                              ...
                              <div class="media-body pr-3 ">
                                ...
                                <p >Taehyung Kim has placed an new order</p>
                              </div>
                            ...
                            <div class="media py-3 align-items-center justify-content-between">
                              ...
                              <div class="media-body pr-3">
                                ...
                                <p >Jimin Park has placed an new order</p>
                              </div>
                            ...
                            <div class="media py-3 align-items-center justify-content-between">
                              ...
                              <div class="media-body pr-3">
                                ...
                                <p >Jungkook Jeon has placed an new order</p>
                              </div>
                              <span class=" font-size-12 d-inline-block"><i class="mdi mdi-clock-outline"></i> 10 AM</span>
                            </div>
                            ...
                            <div class="media py-3 align-items-center justify-content-between">
                              ...
                              <div class="media-body pr-3">
                                <a class="mt-0 mb-1 font-size-15 text-dark" href="#">New order</a>
                                <p >Suga has placed an new order</p>
                              </div>
                              <span class=" font-size-12 d-inline-block"><i class="mdi mdi-clock-outline"></i> 10 AM</span>
                            </div>
                            ...
                            <div class="media py-3 align-items-center justify-content-between">
                              ...
                              <div class="media-body pr-3">
                                ...
                                <p >Seokjin Kim has placed an new order</p>
                              </div>
                              <span class=" font-size-12 d-inline-block"><i class="mdi mdi-clock-outline"></i> 10 AM</span>
                            </div>
                            ...
                            <div class="media py-3 align-items-center justify-content-between">
                              ...
                              <div class="media-body pr-3">
                                <a class="mt-0 mb-1 font-size-15 text-dark" href="#">New Enquiry</a>
                                <p >Lorsia has placed an new order</p>
                              </div>
                              <span class=" font-size-12 d-inline-block"><i class="mdi mdi-clock-outline"></i> 9 AM</span>
                            </div>
                      ...
                      <table class="table card-table table-responsive table-responsive-large" style="width:100%">
                        ...
                        <tbody>
                          <tr>
                            <td >24541</td>
                            <td >
                              <a class="text-dark" href=""> Septihan</a>
                            </td>
                            <td class="d-none d-md-table-cell">3 Unit</td>
                            <td class="d-none d-md-table-cell">Oct 26, 2020</td>
                            <td class="d-none d-md-table-cell">150.000</td>
                            <td >
                          ...
                          <tr>
                            <td >24541</td>
                            <td >
                              <a class="text-dark" href=""> Teluk Alaska, Alaska</a>
                            </td>
                            <td class="d-none d-md-table-cell">2 Units</td>
                            <td class="d-none d-md-table-cell">Oct 24, 2020</td>
                            <td class="d-none d-md-table-cell">100.000</td>
                            <td >
                          ...
                          <tr>
                            <td >24541</td>
                            <td >
                              <a class="text-dark" href=""> Bicara Ada Itu Seninya, Seni Hiudp Minimalis</a>
                            </td>
                            <td class="d-none d-md-table-cell">2 Unit</td>
                            <td class="d-none d-md-table-cell">Nov 24, 2020</td>
                            <td class="d-none d-md-table-cell">455.000</td>
                            <td >
                          ...
                          <tr>
                            <td >24541</td>
                            <td >
                              <a class="text-dark" href=""> Asya Story, Filosofi Teras</a>
                            </td>
                            <td class="d-none d-md-table-cell">2 Units</td>
                            <td class="d-none d-md-table-cell">Oct 26, 2020</td>
                          ...
                          <tr>
                            <td >24541</td>
                            <td >
                              <a class="text-dark" href=""> Detektive Conan</a>
                            </td>
                            <td class="d-none d-md-table-cell">2 Unit</td>
                            <td class="d-none d-md-table-cell">Oct 24, 2020</td>
                    ...
                    <div class="card-body slim-scroll">
                      ...
                      <div class="todo-list" id="todo-list">
                        ...
                        <div class="todo-single-item d-flex flex-row justify-content-between ">
                          <i class="mdi"></i>
                          <span >Update Book</span>
                          <span class="badge badge-success">Oct 27, 2020</span>
                        </div>
                      </div>
                    </div>
                    <div class="mt-3"></div>
                      ...
                      <div class="col-6">
                        <div class="p-4">
                          <ul class="d-flex flex-column justify-content-between">
                            ...
                            <li><i class="mdi mdi-checkbox-blank-circle-outline mr-2" style="color: #4c84ff "></i>Indonesian <span class="float-right">3k</span></li>
                          </ul>
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="p-4 border-left">
                          <ul class="d-flex flex-column justify-content-between">
                            <li class="mb-2"><i class="mdi mdi-checkbox-blank-circle-outline mr-2" style="color: #ffa128"></i>Korean <span class="float-right">4k</span></li>
                            <li><i class="mdi mdi-checkbox-blank-circle-outline mr-2" style="color: #fe5461"></i>Australia <span class="float-right">2k</span></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                            ...
                            <td >
                              <div class="media">
                                ...
                                <div class="media-body align-self-center">
                                  <a href="profile.html"><h6 class="mt-0 text-dark font-weight-medium">Taehyung Kim</h6></a>
                                  <small>@kim.taehyung</small>
                                </div>
                              </div>
                            </td>
                            <td >2 Orders</td>
                            <td class="text-dark d-none d-md-block">150.000</td>
                          </tr>
                          <tr>
                            <td >
                              <div class="media">
                                <div class="media-image mr-3 rounded-circle">
                                  <a href="profile.html"><img class="rounded-circle w-45" src="assets/img/user/user.jpg" alt="customer image"></a>
                                </div>
                                <div class="media-body align-self-center">
                                  <a href="profile.html"><h6 class="mt-0 text-dark font-weight-medium">Lorsia</h6></a>
                                  <small>@lorsia.me</small>
                                </div>
                              </div>
                            </td>
                            <td >2 Orders</td>
                            <td class="text-dark d-none d-md-block">100.000</td>
                          </tr>
                          <tr>
                            <td >
                              <div class="media">
                                ...
                                <div class="media-body align-self-center">
                                  <a href="profile.html"><h6 class="mt-0 text-dark font-weight-medium">Jungkook Jeon</h6></a>
                                  <small>@jeon.jungkook</small>
                                </div>
                              </div>
                            </td>
                            <td >1 Order</td>
                            <td class="text-dark d-none d-md-block">80.000</td>
                          </tr>
                          <tr>
                            <td >
                              <div class="media">
                                ...
                                <div class="media-body align-self-center">
                                  <a href="profile.html"><h6 class="mt-0 text-dark font-weight-medium">Jimin Park</h6></a>
                                  <small>@park.jimin</small>
                                </div>
                              </div>
                            </td>
                            <td >2 Orders</td>
                          ...
                          <tr>
                            <td >
                              <div class="media">
                                ...
                                <div class="media-body align-self-center">
                                  <a href="profile.html"><h6 class="mt-0 text-dark font-weight-medium">Seokjin Kim</h6></a>
                                  <small>@kim.seokjin</small>
                                </div>
                              </div>
                            </td>
                            <td >1 Order</td>
                            <td class="text-dark d-none d-md-block">70.000</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <div class="card card-default" data-scroll-height="580">
                    ...
                    <div class="card-body py-0">
                      <div class="media d-flex mb-5">
                        ...
                        <div class="media-body align-self-center">
                          <a href="#"><h6 class="mb-3 text-dark font-weight-medium"> Asya Story</h6></a>
                          <p class="float-md-right"><span class="text-dark mr-2">100</span>Sales</p>
                          <p class="d-none d-md-block">Novel Wattpad Terbaik Best Seller.</p>
                          <p class="mb-0">
                            <del>65.0000</del>
                            <span class="text-dark ml-3">50.000</span>
                          </p>
                        </div>
                      </div>
                      ...
                      <div class="media d-flex mb-5">
                        ...
                        <div class="media-body align-self-center">
                          <a href="#"><h6 class="mb-3 text-dark font-weight-medium">Sebuah Seni Untuk Bersikap Bodo Amat</h6></a>
                          <p class="float-md-right"><span class="text-dark mr-2">90</span>Sales</p>
                          <p class="d-none d-md-block">Buku Terbaik Best Seller.</p>
                          <p class="mb-0">
                            <del>65.000</del>
                            <span class="text-dark ml-3">55.000</span>
                          </p>
                        </div>
                      </div>
                      ...
                      <div class="media d-flex mb-5">
                        ...
                        <div class="media-body align-self-center">
                          <a href="#"><h6 class="mb-3 text-dark font-weight-medium"> Septihan</h6></a>
                          <p class="float-md-right"><span class="text-dark mr-2">100</span>Sales</p>
                          <p class="d-none d-md-block">Novel Wattpad Terbaik Best Seller.</p>
                          <p class="mb-0">
                            <del>60.000</del>
            ...
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">2020</span> Copyright Book Store by
                <a
                  class="text-primary"
